...
INLINE void led__on(void) {
    mcp251x_select__run(mcp251x_write_one_byte(MCP251X_REGISTER_BFPCTRL, (1<<MCP251X_B0BFS)|(1<<MCP251X_B0BFE)));
}


INLINE void led__off(void) { 
    mcp251x_select__run(mcp251x_write_one_byte(MCP251X_REGISTER_BFPCTRL, 0));
}
