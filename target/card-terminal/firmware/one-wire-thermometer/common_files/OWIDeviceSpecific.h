...
#define OWI_UART_STATCTRL_REG_A     UCSR1A
#define OWI_UART_STATCTRL_REG_B     UCSR1B
#define OWI_UART_STATCTRL_REG_C     UCSR1C
#define OWI_UART_DATA_REGISTER      UDR1
#define OWI_UART_BAUD_RATE_REG_L    UBRR1L
#define OWI_UART_BAUD_RATE_REG_H    UBRR1H

#define OWI_U2X                     U2X1
#define OWI_RXEN                    RXEN1
#define OWI_TXEN                    TXEN1
#define OWI_RXCIE                   RXCIE1
#define OWI_UCSZ1                   UCSZ11
#define OWI_UCSZ0                   UCSZ10
#define OWI_UDRIE                   UDRIE1
#define OWI_FE                      FE1
#define OWI_RXC                     RXC1

#define OWI_UART_RXC_VECT           USART1_RXC_vect
#define OWI_UART_UDRE_VECT          USART1_UDRE_vect


#elif defined(__AT90Mega64__) | defined(__ATmega64__) | \
