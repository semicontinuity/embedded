...
void Lcd_fill(uint8_t value)
{
    ...
    memset( LcdCache, value, LCD_CACHE_SIZE );
...
void Lcd_update (void)
{
    ...
    if ( HiWaterMark < 0 )
        ...
        y = LoWaterMark / LCD_X_RES + 0;  // Устанавливаем начальный адрес y+1
...
//        LcdSend( 0x40, LCD_CMD );    // Сдвигаем картинку на 5 пикселей вверх (нестандартная команда китайца, оригинал её игнорирует)
