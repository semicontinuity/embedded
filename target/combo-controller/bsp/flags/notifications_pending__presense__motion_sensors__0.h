...
DEFINE_BITVAR(notifications_pending__presense__motion_sensors__0, NOTIFICATIONS_PENDING__PRESENSE__MOTION_SENSORS__0__HOST, NOTIFICATIONS_PENDING__PRESENSE__MOTION_SENSORS__0__BIT);
#else
