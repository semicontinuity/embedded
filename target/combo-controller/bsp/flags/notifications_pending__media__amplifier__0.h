...
DEFINE_BITVAR(notifications_pending__media__amplifier__0, NOTIFICATIONS_PENDING__MEDIA__AMPLIFIER__0__HOST, NOTIFICATIONS_PENDING__MEDIA__AMPLIFIER__0__BIT);
#else
