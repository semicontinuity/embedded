...
DEFINE_BITVAR(notifications_pending__emergency__water_actuators__0, NOTIFICATIONS_PENDING__EMERGENCY__WATER_ACTUATORS__0__HOST, NOTIFICATIONS_PENDING__EMERGENCY__WATER_ACTUATORS__0__BIT);
#else
