...
DECLARE_BITVAR(notifications_pending__comm__binary__1, NOTIFICATIONS_PENDING__COMM__BINARY__1__HOST, NOTIFICATIONS_PENDING__COMM__BINARY__1__BIT);
#else
 ...
 */
inline static void notifications_pending__comm__binary__1__init(void) {
    USE_AS_OUTPUT(NOTIFICATIONS_PENDING__COMM__BINARY__1);
}
