#ifndef __COMM_SERVICE__WATER_VALVE_CONTOLLER_H
#define __COMM_SERVICE__WATER_VALVE_CONTOLLER_H
...
inline static void comm_service__water_valve_controller__value__handle(const uint8_t is_get) {
    if (is_get) {
...
inline static void comm_service__water_valve_controller__value__broadcast(void) {
