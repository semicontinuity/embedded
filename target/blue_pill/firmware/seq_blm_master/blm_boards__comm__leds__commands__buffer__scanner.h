...
// of blm_boards__comm__leds__commands__buffer__scanner__run().
// (Protocol 2)
// -----------------------------------------------------------------------------

#include <Arduino.h>
#include "blm_boards__comm__leds__commands__buffer.h"
#include "blm_boards__comm__leds__commands__buffer__scanner__callbacks.h"
 ...
 */
static bool blm_boards__comm__leds__commands__buffer__scanner__scan(unsigned int board) {
...
bool blm_boards__comm__leds__commands__buffer__scanner__is_runnable() {
    return blm_boards__comm__leds__commands__buffer__dirty;
}

void blm_boards__comm__leds__commands__buffer__scanner__run() {
    int board = __builtin_ffs(blm_boards__comm__leds__commands__buffer__dirty) - 1;
    if (board >= 0) {
