...
static bool blm_boards__comm__leds__p4_commands__buffer__scanner__scan(unsigned int board) {
    uint16_t dirty_commands = blm_boards__comm__leds__p4_commands__buffer__commands__dirty[board];
    ...
    if (index >= 0) {
        ...
        blm_boards__comm__leds__p4_commands__buffer__commands__dirty[board] = dirty_commands;
...
bool blm_boards__comm__leds__p4_commands__buffer__scanner__is_runnable() {
    return blm_boards__comm__leds__p4_commands__buffer__dirty;
}

void blm_boards__comm__leds__p4_commands__buffer__scanner__run() {
    int board = __builtin_ffs(blm_boards__comm__leds__p4_commands__buffer__dirty) - 1;
    if (board >= 0) {
        if (blm_boards__comm__leds__p4_commands__buffer__scanner__scan(board)) {
            blm_boards__comm__leds__p4_commands__buffer__dirty &= ~(1U << (uint32_t) board);
        }
