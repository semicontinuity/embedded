...
void blm_master__sysex_handler__handle_request_layout_info() {
    ...
    blm_master__sysex_handler__serial->write(BLM_SCALAR_NUM_BOARDS_X*4);    // Number of columns
    blm_master__sysex_handler__serial->write(BLM_SCALAR_NUM_BOARDS_Y*4);    // Number of rows
