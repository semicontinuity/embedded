...
uint16_t blm_boards__comm__leds__p4_commands__buffer__commands__dirty[16];  // 1 bit means that corresponding command for the board is dirty
uint16_t blm_boards__comm__leds__p4_commands__buffer__dirty;                // 1 bit means that corresponding entry in commands__dirty is dirty
...
void blm_boards__comm__leds__p4_commands__buffer__init() {
    ...
    for (int i = 0; i < 16; i++) {
        blm_boards__comm__leds__p4_commands__buffer__commands__dirty[i] = 0U;
    }
    blm_boards__comm__leds__p4_commands__buffer__dirty = 0U;
}
...
static void blm_boards__comm__leds__p4_commands__buffer__put(uint8_t matrix, uint8_t command_index, uint8_t command) {
    ...
    blm_boards__comm__leds__p4_commands__buffer__commands__dirty[matrix] |= (1U << command_index);
}
