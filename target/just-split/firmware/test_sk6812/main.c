...
#endif
    for(;;) {
        leds__data[0x00*3 + 0]=0x01; leds__data[0x00*3 + 1]=0x00; leds__data[0x00*3 + 2]=0x00;
        leds__data[0x01*3 + 0]=0x00; leds__data[0x01*3 + 1]=0x01; leds__data[0x01*3 + 2]=0x00;
        leds__data[0x02*3 + 0]=0x00; leds__data[0x02*3 + 1]=0x00; leds__data[0x02*3 + 2]=0x01;
        leds__data[0x03*3 + 0]=0x04; leds__data[0x03*3 + 1]=0x04; leds__data[0x03*3 + 2]=0x04;
        leds__data[0x04*3 + 0]=0x02; leds__data[0x04*3 + 1]=0x00; leds__data[0x04*3 + 2]=0x00;
        leds__data[0x05*3 + 0]=0x00; leds__data[0x05*3 + 1]=0x02; leds__data[0x05*3 + 2]=0x00;
        leds__data[0x06*3 + 0]=0x00; leds__data[0x06*3 + 1]=0x00; leds__data[0x06*3 + 2]=0x02;
        leds__data[0x07*3 + 0]=0x03; leds__data[0x07*3 + 1]=0x03; leds__data[0x07*3 + 2]=0x03;

        leds__data[0x08*3 + 0]=0x04; leds__data[0x08*3 + 1]=0x00; leds__data[0x08*3 + 2]=0x00;
        leds__data[0x09*3 + 0]=0x00; leds__data[0x09*3 + 1]=0x04; leds__data[0x09*3 + 2]=0x00;
        leds__data[0x0a*3 + 0]=0x00; leds__data[0x0a*3 + 1]=0x00; leds__data[0x0a*3 + 2]=0x04;
        leds__data[0x0b*3 + 0]=0x02; leds__data[0x0b*3 + 1]=0x02; leds__data[0x0b*3 + 2]=0x02;
        leds__data[0x0c*3 + 0]=0x06; leds__data[0x0c*3 + 1]=0x00; leds__data[0x0c*3 + 2]=0x00;
        leds__data[0x0d*3 + 0]=0x00; leds__data[0x0d*3 + 1]=0x06; leds__data[0x0d*3 + 2]=0x00;
        leds__data[0x0e*3 + 0]=0x00; leds__data[0x0e*3 + 1]=0x00; leds__data[0x0e*3 + 2]=0x06;
        leds__data[0x0f*3 + 0]=0x01; leds__data[0x0f*3 + 1]=0x01; leds__data[0x0f*3 + 2]=0x01;
