 ...
 *
 * An die Klemmleiste OW werden die einzelnen DS18B20 über einen "Klingeldraht"-Bus
 * hintereinander angeschlossen. Kurze Abzweige sind möglich. Funktionieren tut das
