...
void APP_Init(void)
{
  mios32_lcd_parameters_t lcd_parameters = {
  ...
  MIOS32_LCD_ParametersSet(lcd_parameters);
...
#if DEBUG_VERBOSE_LEVEL >= 1
      if( SDCARD_Mount() < 0 ) {
	DEBUG_MSG("ERROR mounting Card!\n");
      } else {
	DEBUG_MSG("SD Card mounted!\n");
      }
#endif
