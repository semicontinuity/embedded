...
#pragma clang diagnostic ignored "-Wmissing-noreturn"
    ...
    for(;;) {
        ...
        __asm__ __volatile__("main__loop__0:");
        usart0__out__write(io_matrix__in__column0__state__get());
        __asm__ __volatile__("main__loop__1:");
        usart0__out__write(io_matrix__in__column1__state__get());
        __asm__ __volatile__("main__loop__2:");
        usart0__out__write(io_matrix__in__column2__state__get());
        __asm__ __volatile__("main__loop__3:");
        usart0__out__write(io_matrix__in__column3__state__get());
    }
