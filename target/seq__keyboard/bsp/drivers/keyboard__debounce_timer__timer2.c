...
#define SYSTEM_TIMER__CONF__INITIALIZED (TIMER2_CONF_DEFAULT)
#define SYSTEM_TIMER__CONF__STARTED     (TIMER2_CONF_PRESCALER_1024)
...
void keyboard__debounce_timer__start(void) {
    ...
    timer2__switch_basic_conf(SYSTEM_TIMER__CONF__INITIALIZED, SYSTEM_TIMER__CONF__STARTED);
}

void keyboard__debounce_timer__expired(void) {
    timer2__switch_basic_conf(SYSTEM_TIMER__CONF__STARTED, SYSTEM_TIMER__CONF__INITIALIZED);
