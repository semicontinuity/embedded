...
inline void led1r_row__init(void) {
    USE_AS_OUTPUT(IO_MATRIX__OUT__LED1R_ROW);
}

inline void led1g_row__init(void) {
    USE_AS_OUTPUT(IO_MATRIX__OUT__LED1G_ROW);
}

inline void led1b_row__init(void) {
    USE_AS_OUTPUT(IO_MATRIX__OUT__LED1B_ROW);
}

inline void led2r_row__init(void) {
    USE_AS_OUTPUT(IO_MATRIX__OUT__LED2R_ROW);
}

inline void led2g_row__init(void) {
    USE_AS_OUTPUT(IO_MATRIX__OUT__LED2G_ROW);
}

inline void led2b_row__init(void) {
    USE_AS_OUTPUT(IO_MATRIX__OUT__LED2B_ROW);
}

inline void buttons__leds_row__init(void) {
    USE_AS_OUTPUT(IO_MATRIX__OUT__BUTTONS_LEDS_ROW);
}
