...
VT_FUNC(io_matrix__scanner__thread__function, io_matrix__scanner__thread__function_attrs) {
    FC_RESUME(io_matrix__scanner__thread__ip);
    {
        ...
        VT_Z_YIELD_WITH_MARK_RETI(io_matrix__scanner__thread, io_matrix__scanner__thread__ip, COLUMN0_READ);
        ...
        VT_Z_YIELD_WITH_MARK_RETI(io_matrix__scanner__thread, io_matrix__scanner__thread__ip, COLUMN1_READ);
        ...
        VT_Z_YIELD_WITH_MARK_RETI(io_matrix__scanner__thread, io_matrix__scanner__thread__ip, COLUMN2_READ);
        ...
        VT_Z_YIELD_WITH_MARK_RETI(io_matrix__scanner__thread, io_matrix__scanner__thread__ip, COLUMN3_READ);
