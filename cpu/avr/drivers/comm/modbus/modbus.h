#ifndef CPU__AVR__DRIVERS__COMM__MODBUS__MODBUS_H
#define CPU__AVR__DRIVERS__COMM__MODBUS__MODBUS_H
...
#define MODBUS_FUNCTION__READ_DISCRETE_INPUTS__PAYLOAD_SIZE     (4)
