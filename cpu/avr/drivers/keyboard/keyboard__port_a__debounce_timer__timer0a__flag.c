...
// implemented with Timer 0 Compare A channel.
...
//
// KEYBOARD__PORT_A__DEBOUNCE_TIMER__CONF__INITIALIZED
// KEYBOARD__PORT_A__DEBOUNCE_TIMER__CONF__STARTED
// KEYBOARD__PORT_A__DEBOUNCE_TIMER__DELAY
// =============================================================================
...
bool keyboard__port_a__debounce_timer__is_started(void) {
