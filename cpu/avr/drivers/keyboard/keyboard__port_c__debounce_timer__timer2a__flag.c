...
// implemented with Timer 2 Compare A channel.
...
//
// KEYBOARD__PORT_C__DEBOUNCE_TIMER__CONF__INITIALIZED
// KEYBOARD__PORT_C__DEBOUNCE_TIMER__CONF__STARTED
// KEYBOARD__PORT_C__DEBOUNCE_TIMER__DELAY
// =============================================================================
...
bool keyboard__port_c__debounce_timer__is_started(void) {
    // if there is no pending interrupt, it means, that debounce timer is still started (timeout has not elapsed)
    return !timer2__compare_a__interrupt__pending__get();
}
