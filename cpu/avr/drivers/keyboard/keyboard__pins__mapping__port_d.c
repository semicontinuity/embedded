...
uint8_t keyboard__pins__port_d__pins_mask(void) {
    return keyboard__pins__port_d__button_pins_mask() | keyboard__pins__port_d__encoders_pins_mask();
}
