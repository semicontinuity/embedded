...
uint8_t keyboard__pins__port_b__encoders_pins_mask(void) {
    uint8_t mask = 0;
    mask |= (1U << keyboard__pins__port_b__pin_a_for_encoder(0));
    mask |= (1U << keyboard__pins__port_b__pin_b_for_encoder(0));
    mask |= (1U << keyboard__pins__port_b__pin_a_for_encoder(1));
    mask |= (1U << keyboard__pins__port_b__pin_b_for_encoder(1));
    mask |= (1U << keyboard__pins__port_b__pin_a_for_encoder(2));
    mask |= (1U << keyboard__pins__port_b__pin_b_for_encoder(2));
