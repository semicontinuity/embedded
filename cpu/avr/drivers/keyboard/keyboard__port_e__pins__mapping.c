...
/**
 * Provides pin number for the given encoder E pin (if it pertains to port E)
...
uint8_t keyboard__pins__port_e__encoders_pins_mask(void) {
    uint8_t mask = 0;
    mask |= (1U << keyboard__pins__port_e__pin_a_for_encoder(0));
    mask |= (1U << keyboard__pins__port_e__pin_b_for_encoder(0));
    mask |= (1U << keyboard__pins__port_e__pin_a_for_encoder(1));
    mask |= (1U << keyboard__pins__port_e__pin_b_for_encoder(1));
    mask |= (1U << keyboard__pins__port_e__pin_a_for_encoder(2));
    mask |= (1U << keyboard__pins__port_e__pin_b_for_encoder(2));
    mask |= (1U << keyboard__pins__port_e__pin_a_for_encoder(3));
    mask |= (1U << keyboard__pins__port_e__pin_b_for_encoder(3));
    return mask;
}


uint8_t keyboard__pins__port_e__pins_mask(void) {
    return keyboard__pins__port_e__button_pins_mask() | keyboard__pins__port_e__encoders_pins_mask();
}
