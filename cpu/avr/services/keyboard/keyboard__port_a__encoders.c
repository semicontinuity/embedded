...
void keyboard__port_a__encoders__process_encoder(uint8_t state, uint8_t changes, uint8_t encoder) {
    uint8_t pin_a = keyboard__pins__port_a__pin_a_for_encoder(encoder);
    uint8_t pin_b = keyboard__pins__port_a__pin_b_for_encoder(encoder);
...
void keyboard__port_a__encoders__process(uint8_t state, uint8_t changes) {
    __asm__ __volatile__("keyboard__port_a__encoders__process_encoder__3:");
    keyboard__port_a__encoders__process_encoder(state, changes, 3);
    __asm__ __volatile__("keyboard__port_a__encoders__process_encoder__2:");
    keyboard__port_a__encoders__process_encoder(state, changes, 2);
    __asm__ __volatile__("keyboard__port_a__encoders__process_encoder__1:");
    keyboard__port_a__encoders__process_encoder(state, changes, 1);
    __asm__ __volatile__("keyboard__port_a__encoders__process_encoder__0:");
