...
void keyboard__port_c__encoders__process_encoder(uint8_t state, uint8_t changes, uint8_t encoder) {
    ...
    if (changes & ((uint8_t) (1U << pin_a))) {
        ...
        keyboard__port_c__mask__clear_bit(pin_a);
        keyboard__port_c__previous_state__copy_bit(state, pin_a);
    ...
    if (changes & ((uint8_t) (1U << pin_b))) {
        ...
        keyboard__port_c__mask__clear_bit(pin_b);
        keyboard__port_c__previous_state__copy_bit(state, pin_b);
