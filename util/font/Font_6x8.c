...
const uint8_t PROGMEM Font_6x8_Data[] =
{
...
// Odифт 6 на 8 пикселов.
// Iовтоdяет odифт Terminal Microsoft Windows.

struct FONT Font_6x8 =
{
  8,                    // Aысота символа в пикселаo.
  6,                    // Oиdина символа в пикселаo.
  255,                  // xисло символов в odифте.
  Font_6x8_Data     // Aдdес таблицы описания символов odифта.
};
