...
uint8_t const PROGMEM Font_7x10_bold_Data[] =
{
...
// Odифт 7 на 10 пикселов утолщенный (Bold).
// Iовтоdяет odифт DOSApp-105 (7 на 12) Microsoft Windows (обdезаны две нижние стdоки).

struct FONT Font_7x10_bold =
{
  10,                       // Aысота символа в пикселаo.
  7,                        // Oиdина символа в пикселаo.
  255,                      // xисло символов в odифте.
  &Font_7x10_bold_Data[0]   // Aдdес таблицы описания символов odифта.
};
